...
public class ImageValidation extends FileValidation{
	...
	/**
	 * Constructor.
	 * Validates default images with:
	 * 	- allowed file extensions: "gif", "jpeg", "jpg", "png", "svg", "blob"
	 *  - allowed mime types: "image/gif", "image/jpeg", "image/pjpeg", "image/x-png", "image/png", "image/svg+xml"
	 */
	...
	/**
	 * Constructor.
	 * @param allowedExts Allowed validation image extensions.
	 * @param allowedMimeTypes Allowed validation image mimetypes.
	 */
